...
<script setup>
import BirthdayCake from '../assets/imgs/11.jpg';
import WeddingCake from '../assets/imgs/13.jpg';
import ChristmasCake from '../assets/imgs/12.jpg';
</script>
...
/* #christmas {
  ...
  background-image: url('src/assets/imgs/12.jpg');
